...
Version  : 5.0.0
Release  : 51
URL      : https://files.pythonhosted.org/packages/61/1f/44d9efc904bbe4d9967433522b691a9c4f1e81c2c64fbe44bad63d5de646/async_timeout-5.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/61/1f/44d9efc904bbe4d9967433522b691a9c4f1e81c2c64fbe44bad63d5de646/async_timeout-5.0.0.tar.gz
...
%prep
%setup -q -n async_timeout-5.0.0
cd %{_builddir}/async_timeout-5.0.0
pushd ..
cp -a async_timeout-5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730385092
